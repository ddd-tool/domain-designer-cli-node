...
export async function requireGenCsharpContext(): Promise<define.csharp.CSharpContext> {
    ...
    [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            title: define.csharp.CSharpGeneratorAddition.CommandHandlerInterface,
            value: define.csharp.CSharpGeneratorAddition.CommandHandlerInterface,
            selected: false,
  ...
  if (context.additions.has(define.csharp.CSharpGeneratorAddition.CommandHandlerInterface)) {
  ...
  if (context.additions.has(define.csharp.CSharpGeneratorAddition.AggInterface)) {
