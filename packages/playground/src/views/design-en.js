...
const orderAggregation = d.agg('orderAggregation', [orderId, orderTime, userAccount, productPrice, productQuantity, orderAmount], 'this is order aggregation');
// command
...
// rule
const paymentRule = d.policy('paymentRule', d.note `
...
export default d;
//# sourceMappingURL=design-en.js.map