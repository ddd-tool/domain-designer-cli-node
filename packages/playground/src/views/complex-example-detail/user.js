...
const 启用会员账户 = d.command('ResumeAccount', ['userId'], d.note `启用会员账户
    1.会员账户当前被暂停才能启用`);
...
const 会员账号已创建 = d.event('UserAccountCreatedEvt', ['会员id : userId', '会员名'], '会员账号已创建');
export const 会员账号读模型 = d.readModel('UserAccountStatsRM', ['会员id : userId', '会员名', '是否暂停', '累计逾期次数'], '会员账号读模型');
