...
export type DomainDesignInfoProvider = () => {
    ...
    valueObj<NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, string> | string>>(name: NAME, infos: ARR, desc?: string | DomainDesignDesc): DomainDesignInfo<'ValueObject', NAME>;
...
export type DomainDesignInfoSubtype<TYPE extends DomainDesignInfoType> = TYPE extends 'Document' | 'Id' | 'Version' ? 'None' : TYPE extends 'Function' ? DomainDesignInfoFuncDependsOn[] : TYPE extends 'ValueObject' ? DomainDesignInfo<DomainDesignInfoType, string>[] : never;
...
export type CustomInfoArrayToInfoObject<ARR extends Array<DomainDesignInfo<any, any> | string>> = {
    [K in ARR[number] as K extends DomainDesignInfo<any, infer U> ? U : K extends string ? K : never]: K extends DomainDesignInfo<any, any> ? K : K extends string ? DomainDesignInfo<'ValueObject', K> : never;
};
...
export type DomainDesignCommandProvider = {
    <G_NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, G_NAME> | G_NAME>>(name: string, infos: ARR | NonEmptyInitFunc<() => ARR>, desc?: string | DomainDesignDesc): DomainDesignCommand<CustomInfoArrayToInfoObject<ARR>>;
};
...
export type DomainDesignFacadeCommandProvider = {
    <G_NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, G_NAME> | G_NAME>>(name: string, infos: ARR | NonEmptyInitFunc<() => ARR>, desc?: string | DomainDesignDesc): DomainDesignFacadeCommand<CustomInfoArrayToInfoObject<ARR>>;
};
...
export type DomainDesignEventProvider = {
    <G_NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, G_NAME> | G_NAME>>(name: string, infos: ARR | NonEmptyInitFunc<() => ARR>, desc?: string | DomainDesignDesc): DomainDesignEvent<CustomInfoArrayToInfoObject<ARR>>;
};
...
export type DomainDesignAggProvider = {
    <G_NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, G_NAME> | G_NAME>>(name: string, infos: ARR | NonEmptyInitFunc<() => ARR>, desc?: string | DomainDesignDesc): DomainDesignAgg<CustomInfoArrayToInfoObject<ARR>>;
};
...
export type DomainDesignReadModelProvider = {
    <G_NAME extends string, ARR extends NonEmptyArray<DomainDesignInfo<DomainDesignInfoType, G_NAME> | G_NAME>>(name: string, infos: ARR | NonEmptyInitFunc<() => ARR>, desc?: string | DomainDesignDesc): DomainDesignReadModel<CustomInfoArrayToInfoObject<ARR>>;
};
