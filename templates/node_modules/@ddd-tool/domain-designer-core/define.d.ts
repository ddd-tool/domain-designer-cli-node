...
export type DomainDesignRule = 'Desc' | 'Info' | 'Actor' | 'Command' | 'FacadeCommand' | 'Event' | 'Agg' | 'System' | 'Policy' | 'Service' | 'ReadModel';
...
export type DomainDesignDescInject = DomainDesignInfo<any, any> | DomainDesignCommand<any> | DomainDesignFacadeCommand<any> | DomainDesignEvent<any> | DomainDesignAgg<any> | DomainDesignActor | DomainDesignSystem | DomainDesignPolicy | DomainDesignService;
