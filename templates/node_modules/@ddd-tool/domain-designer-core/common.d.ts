...
declare function createInternalContext(initFn: ContextInitializer): {
    ...
    getCommands(): Readonly<{
        ...
        agg<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, agg: ARR, desc?: string | import("./define").DomainDesignDesc): DomainDesignAgg<CustomInfoArrayToInfoObject<ARR>>;
        toFormat(): string;
    }>[];
    ...
    getEvents(): Readonly<{
        ...
        readModel<READ_MODEL extends DomainDesignReadModel<any>>(readModel: READ_MODEL): READ_MODEL;
        readModel<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, infos: ARR | import("./define").NonEmptyInitFunc<() => ARR>): DomainDesignReadModel<CustomInfoArrayToInfoObject<ARR>>;
        toFormat(): string;
    }>[];
    ...
    getServices(): Readonly<{
        ...
        command<COMMAND extends DomainDesignCommand<any>>(command: COMMAND): COMMAND;
        command<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, infos: ARR, desc?: string | import("./define").DomainDesignDesc): DomainDesignCommand<CustomInfoArrayToInfoObject<ARR>>;
        facadeCmd<FACADECMD extends DomainDesignFacadeCommand<any>>(facadeCmd: FACADECMD): FACADECMD;
        facadeCmd<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, infos: ARR, desc?: string | import("./define").DomainDesignDesc): DomainDesignFacadeCommand<CustomInfoArrayToInfoObject<ARR>>;
        agg<AGG extends DomainDesignAgg<any>>(agg: AGG): AGG;
        agg<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, agg: ARR, desc?: string | import("./define").DomainDesignDesc): DomainDesignAgg<CustomInfoArrayToInfoObject<ARR>>;
        toFormat(): string;
    }>[];
    ...
    getAggs(): Readonly<{
        ...
        event<G_NAME extends string, ARR extends NonEmptyArray<CustomInfo<G_NAME>>>(name: string, infos: ARR, desc?: string | import("./define").DomainDesignDesc): DomainDesignEvent<CustomInfoArrayToInfoObject<ARR>>;
        toFormat(): string;
    }>[];
    ...
    info: {
        ...
        func<NAME extends string>(name: NAME, dependsOn: NonEmptyArray<import("./define").DomainDesignInfoFuncDependsOn | string | [string, string | import("./define").DomainDesignDesc]>, desc?: string | import("./define").DomainDesignDesc): DomainDesignInfo<"Function", NAME>;
